...
#programın tek kullanımlık veya her seferinde yeniden elle çalıştırılmasını engellemek için
#while döngüsünü kullanıyoruz, bu döngü sayesinde aksi bir komut alana kadar program yeniden 
#çalışmauya devam ediyor.

    if soru == "q":
        print("çıkılıyor...")
        break
#break başlattığımız while döngüsünü durdurmak için kullanılan bir deyim. bunun gerçekleşmesi için 
#bir if belirliyor ve programın durması için belirlediğimiz parametrenin kullanıcı tarafınfan 
#girilmesini sağlıyoruz.n döngüyü kırıyoruz.
